              ...
              <form id="demo-form2" method="post" action="<?php echo e(route('apply.instructor')); ?>" data-parsley-validate 
                class="form-horizontal form-label-left" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="detail"><?php echo e(__('Details')); ?>:<sup class="redstar">*</sup></label>
...
<?php /**PATH F:\downloaded apps\xampp\htdocs\edutask\resources\views/instructormodel.blade.php ENDPATH**/ ?>