<head>
<meta charset="utf-8" />
<title><?php echo e(__('Network Error | ')); ?><?php echo e($gsetting->project_title); ?></title>
...
<link href="<?php echo e(url('vendor/fontawesome/css/all.css')); ?>"  rel="stylesheet"> <!--  fontawesome css -->
<link href="<?php echo e(url('vendor/font/flaticon.css')); ?>" rel="stylesheet"> <!--  fontawesome css -->
<link href="<?php echo e(url('vendor/navigation/menumaker.css')); ?>" rel="stylesheet"> <!-- navigation css -->
<link href="<?php echo e(url('vendor/owl/css/owl.carousel.min.css')); ?>" rel="stylesheet"> <!-- owl carousel css -->
<link href="<?php echo e(url('vendor/protip/protip.css')); ?>" rel="stylesheet"> <!-- menu css -->
<link href="<?php echo e(url('css/style.css')); ?>" rel="stylesheet" type="text/css"> <!-- custom css -->
<link href="<?php echo e(URL::asset('css/pace.min.css')); ?>" rel="stylesheet">
<link href="<?php echo e(url('css/protip.css')); ?>" rel="stylesheet" type="text/css"> <!-- protip css -->
<!-- end theme styles -->
</head>
<body>
<!-- error page -->
<section id="error" class="error-page-main-block">
    <div class="container-xl">
        <div class="error-block text-center"> 
            <h1><?php echo e(__('You are currently not connected to any networks.')); ?></h1>
            <div class="nav-bar-btn btm-20">
                <a href="<?php echo e(url('/')); ?>" class="btn btn-secondary" title="home"><i class="fa fa-chevron-left"></i><?php echo e(__('Back to Home')); ?></a>
            </div>
        </div>
    </div>
</section>
...
<?php /**PATH F:\downloaded apps\xampp\htdocs\edutask\resources\views/offline.blade.php ENDPATH**/ ?>