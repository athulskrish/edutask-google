...
<link rel="stylesheet" href="<?php echo e(url('vendor/font/flaticon.css')); ?>" /> <!-- flaticon css -->
...
<link rel="stylesheet" href="<?php echo e(asset('css/custom-style.css')); ?>"/><!-- custom style css -->
...
<link rel="stylesheet" href="<?php echo e(asset('css/videoplayer.css')); ?>" />
<link rel="stylesheet" href="<?php echo e(url('css/simple_line_icons/css/simple-line-icons.css')); ?>">  <!-- line icon -->
...
?>
<meta name="google-site-verification" content="<?php echo e($gsetting->google_search_console); ?>">
...
<?php endif; ?>
<?php if(isset($gsetting->google_ana)): ?>
...
<?php echo $__env->yieldContent('custom-head'); ?><?php /**PATH F:\downloaded apps\xampp\htdocs\edutask\resources\views/theme/head.blade.php ENDPATH**/ ?>