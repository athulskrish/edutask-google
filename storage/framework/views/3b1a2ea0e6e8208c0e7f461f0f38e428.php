...
<div class="offcanvas-menu">
    <div class="row">
        <div class="col-lg-8">
            <h4 class="ai-title"><img src="<?php echo e(url('admin_assets/assets/images/svg-icon/ai_2.svg')); ?>" class="img-fluid" alt="<?php echo e(__('Ai Tool')); ?>">Ai Tool</h4>
        </div>
        <div class="col-lg-4">
...
<?php /**PATH /home/keramfvp/edutech.keralify.com/resources/views/admin/openai/topbar.blade.php ENDPATH**/ ?>