<div class="ai-generate-image scroll-down">
    ...
    <img src="<?php echo e($imageUrl ?? ''); ?>" class="img-fluid" alt="<?php echo e(__('Ai image')); ?>">
    <?php endif; ?>
...
</div><?php /**PATH /home/keramfvp/edutech.keralify.com/resources/views/admin/openai/image.blade.php ENDPATH**/ ?>