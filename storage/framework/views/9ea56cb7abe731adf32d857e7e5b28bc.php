...
<?php if(in_array($language,$rtl)): ?>
	...
	<!-- jQuery ui css -->
	<link href="<?php echo e(url('admin_assets/assets/css/dark_style.css')); ?>" rel="stylesheet" type="text/css">
...
<?php endif; ?>
<?php echo $__env->yieldContent('stylesheet'); ?><?php /**PATH /home/keramfvp/edutech.keralify.com/resources/views/admin/layouts/head.blade.php ENDPATH**/ ?>