            ...
            <div class="row no-gutters">
                <div class="col-lg-6 col-md-6">
                    <div class="signup-side-block">
                        <img src="<?php echo e(url('images/login/login.png')); ?>" class="img-fluid" alt=" <?php echo e($gsetting->text); ?>">
                        <div class="login-img">
                            <img src="<?php echo e(url('/images/login/'.$gsetting->img)); ?>" class="img-fluid" alt=" <?php echo e($gsetting->text); ?>">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="signup-heading">
                        ...
                        <div class="signup-block">
                            ...
                            <div class="sign-up text-center"><?php echo e(__('Do not have an account')); ?>?<a href="<?php echo e(url('registers')); ?>" title="sign-up"> <?php echo e(__('Signup')); ?></a>
                            </div>
                            <hr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\downloaded apps\xampp\htdocs\edutask\resources\views/auth/login.blade.php ENDPATH**/ ?>