    ...
    <div class="container-xl">
        <div id="categories-tab-slider" class="categories-tab-block owl-carousel">
            ...
            <div class="item categories-tab-dtl">
                <a href="<?php echo e(route('category.page',['slug' => $cat->slug])); ?>"
        ...
        <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="lazy item home-slider-img">
                <div id="home" class="home-main-block"
                    ...
                    <div class="container-xl">
                        <div class="row">
                            <div class="col-lg-12 <?php echo e($slider['left'] == 1 ? 'col-md-offset-6 col-sm-offset-6 col-sm-12 col-md-12 text-right' : ''); ?>">
                                <div class="home-dtl">
                                    <div class="home-heading"><?php echo e($slider['heading']); ?></div>
                                    <div class="home-sub-heading btm-20"><?php echo e($slider['sub_heading']); ?></div>
                                    <p class="btm-20"><?php echo e($slider['detail']); ?></p>
                                </div>
...
<!-- fact start -->
<?php if($hsetting->fact_enable == 1 && isset($factsetting) && !$factsetting->isEmpty()): ?>
                        ...
                        <div class="facts-block text-center">
                            <div class="facts-block-one">
                                <div class="facts-block-img">
                                    ...
                                    ?>
                                    <img src="<?php echo e($image); ?>" class="img-fluid" alt="<?php echo e($factset->title); ?>" />
                                    <div class="facts-count counter" data-count="<?php echo e($factset->number); ?>"><?php echo e($factset->number); ?></div>
                                </div>
                                <h5 class="facts-title"><a href="#" title="<?php echo e($factset->title); ?>"><?php echo e($factset->title); ?></a></h5>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="view-button">
                    <a href="<?php echo e(url('discount-courses')); ?>" class="btn btn-secondary" title="View More"><?php echo e(__('View More')); ?><i data-feather="chevrons-right"></i>
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="genre-slide-image <?php if($gsetting['course_hover'] == 1): ?> protip <?php endif; ?>"
                    ...
                    <div class="view-block">
                        <div class="view-img">
                            ...
                            <a href="<?php echo e(route('user.course.show',['slug' => $discount->slug ])); ?>"><img
                        ...
                        <div class="view-user-img">
                            ...
                            <a href="<?php echo e(route('all/profile',$discount->user->id)); ?>" title="<?php echo e($discount->title); ?>"><img src="<?php echo e(asset('images/user_img/'.$discount->user['user_img'])); ?>"
                                    class="img-fluid user-img-one" alt="<?php echo e($discount->title); ?>"></a>
                            <?php else: ?>
                            <a href="<?php echo e(route('all/profile',$discount->id)); ?>" title=" <?php echo e($discount->title); ?> "><img src="<?php echo e(asset('images/default/user.png')); ?>"
                                    class="img-fluid user-img-one" alt="<?php echo e($discount->title); ?>"></a>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="view-dtl">
                            <div class="view-heading"><a
                                    href="<?php echo e(route('user.course.show',['slug' => $discount->slug ])); ?>"><?php echo e(str_limit($discount->title, $limit = 30, $end = '...')); ?></a>
                            </div>
                            <div class="user-name">
                                ...
                                <div class="protip-wishlist">
                                    <ul>
                                        <li class="protip-wish-btn"><a
                                                ...
                                                target="__blank" title="<?php echo e(__('Reminder')); ?>"><i data-feather="bell"></i></a></li>
                                        <?php if(Auth::check()): ?>
                                        ...
                                        <li class="protip-wish-btn">
                                            <form id="demo-form2" method="post"
                                                ...
                                                <button class="wishlisht-btn" title="<?php echo e(__('Add to Wishlist')); ?>" type="submit"><i
                                        ...
                                        <?php endif; ?>
                                        <?php else: ?>
                                        <li class="protip-wish-btn"><a href="<?php echo e(route('login')); ?>" title="<?php echo e(__('Login')); ?>"><i
                        ...
                        <div class="prime-description-under-block">
                                        ...
                                        <div class="img-wishlist">
                                            <div class="protip-wishlist">
                                                <ul>
                                                    ...
                                                    <?php else: ?>
                                                        <li class="protip-wish-btn">
                                                            <a href="<?php echo e(route('login')); ?>" title="<?php echo e(__('Login')); ?>"><i data-feather="heart"></i></a>
                                                        </li>
                                                    <?php endif; ?>
                                                </ul>
                                            </div>
                            ...
                            <div>
                                ...
                                <div class="product-learn-dtl">
                                    <ul>
                                        <li><i data-feather="check-circle"></i><?php echo e(str_limit($wl['detail'], $limit = 120, $end = '...')); ?>
                                        ...
                                        <div class="protip-btn">
                                            <?php if($discount->type == 1): ?>
                                                <?php if($isAdmin || ($isUserLoggedIn && $hasEnrollment)): ?>
                                                    <a href="<?php echo e(route('course.content',['slug' => $discount->slug ])); ?>"
                ...
                <div class="genre-slide-image">
                    <div class="view-block">
                        ...
                        <div class="view-user-img">
                            ...
                            <a href="<?php echo e(route('all/profile',$recent_course->user->id)); ?>" title="<?php echo e($recent_course->title); ?> "><img
                                    src="<?php echo e(asset('images/user_img/'.$recent_course->user['user_img'])); ?>"
                                    class="img-fluid user-img-one" alt="<?php echo e($recent_course->title); ?>"></a>
                            <?php else: ?>
                            <a href="<?php echo e(route('all/profile',$recent_course->user->id)); ?>" title=" <?php echo e($recent_course->title); ?>"><img src="<?php echo e(asset('images/default/user.png')); ?>"
                                    class="img-fluid user-img-one" alt="<?php echo e($recent_course->title); ?>"></a>
                            <?php endif; ?>
                        </div>
                        <div class="view-dtl">
                            <div class="view-heading"><a
                                    href="<?php echo e(route('user.course.show',['slug' => $recent_course->slug ])); ?>"><?php echo e(str_limit($recent_course->title, $limit = 30, $end = '...')); ?></a>
                            </div>
                            <div class="user-name">
                ...
                <div class="genre-slide-image">
                    <div class="view-block">
                        <div class="view-img">
                            ...
                            <a
                                href="<?php echo e(route('course.content',['slug' => $enrol->courses->slug ])); ?>"><img
                        ...
                        <div class="view-user-img">
                            ...
                            <a href="<?php echo e(route('all/profile',$enrol->user->id)); ?>" title=" <?php echo e($enrol->courses->title); ?> "><img src="<?php echo e(asset('images/user_img/'.$enrol->user['user_img'])); ?>"
                                    class="img-fluid user-img-one" alt="<?php echo e($enrol->courses->title); ?>"></a>
                            <?php else: ?>
                            <a href="<?php echo e(route('all/profile',$enrol->user->id)); ?>" title=" <?php echo e($enrol->courses->title); ?> "><img src="<?php echo e(asset('images/default/user.png')); ?>"
                                    class="img-fluid user-img-one" alt="<?php echo e($enrol->courses->title); ?>"></a>
                            <?php endif; ?>
                        </div>
                        <div class="view-dtl">
                            <div class="view-heading"><a
                                    href="<?php echo e(route('course.content',['slug' => $enrol->courses->slug ])); ?>" title=" <?php echo e($enrol->courses->title); ?> "><?php echo e(str_limit($enrol->courses->title, $limit = 30, $end = '...')); ?></a>
                            </div>
                            <div class="user-name">
                                                ...
                                                <?php if($course->type == 1): ?>
                                                    <?php if($discountPrice !== null): ?>
                                                        <li>
                                                            <a>
                                                                <b>
                                                                    <?php if($symbolPosition == 'l'): ?> <?php echo e($symbol); ?> <?php endif; ?>
                                                                    <?php echo e(price_format($discountPrice)); ?>

                                                                    <?php if($symbolPosition == 'r'): ?> <?php echo e($symbol); ?> <?php endif; ?>
                                                                </b>
                                                            </a>
                                                        </li>
                                                        <li>
    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="view-button">
                    <a href="<?php echo e(url('featured-courses')); ?>" class="btn btn-secondary" title="View More"><?php echo e(__('View More')); ?><i data-feather="chevrons-right"></i>
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="genre-slide-image <?php if($gsetting['course_hover'] == 1): ?> protip <?php endif; ?>"
                    ...
                    <?php if(isset($c->user->id)): ?>
                        <div class="view-user-img">
                            ...
                            <a href="<?php echo e(route('all/profile',$c->user->id)); ?>" title=" <?php echo e($c->title); ?> "><img src="<?php echo e(asset('images/user_img/'.$c->user['user_img'])); ?>"
                                    class="img-fluid user-img-one" alt="<?php echo e($c->title); ?> "></a>
                            <?php else: ?>
                            <a href="<?php echo e(route('all/profile',$c->user->id)); ?>" title=" <?php echo e($c->title); ?> "><img src="<?php echo e(asset('images/default/user.png')); ?>"
                                    class="img-fluid user-img-one" alt="<?php echo e($c->title); ?> "></a>
                            <?php endif; ?>
                        </div>
                        <div class="view-dtl">
                            <div class="view-heading"><a
                                    href="<?php echo e(route('user.course.show',['slug' => $c->slug ])); ?>" title=" <?php echo e($c->title); ?> "><?php echo e(str_limit($c->title, $limit = 30, $end = '...')); ?></a>
                            </div>
                            <div class="user-name">
                                        ...
                                        <?php if($c->type == 1): ?>
                                            <?php if(Auth::check()): ?>
                                                <?php if(Auth::User()->role == "admin" || (!empty($order) && $order->status == 1)): ?>
                                                    <div class="protip-btn">
                                                        <a href="<?php echo e(route('course.content',['slug' => $c->slug ])); ?>"
                                                            class="btn btn-secondary" title="course"><?php echo e(__('Go To Course')); ?></a>
                                                    </div>
                                                <?php else: ?>
                                                    <?php
        ...
        <div id="subscription-bundle-view-slider" class="student-view-slider-main-block owl-carousel">
            ...
            <div class="item student-view-block student-view-block-1">
                <div class="genre-slide-image protip" data-pt-placement="outside" data-pt-interactive="false"
                    ...
                    <div class="view-block">
                        <div class="view-img">
                            <a href="<?php echo e(route('bundle.detail', $bundle->slug)); ?>" title="<?php echo e($bundle->user->fname); ?>">
                        ...
                        <div class="view-user-img">
                            <a href="<?php echo e(route('all/profile', $bundle->user->id)); ?>" title="<?php echo e($bundle->user->fname); ?>">
                                <img src="<?php echo e(asset('images/user_img/' . ($bundle->user['user_img'] ?? 'default/user.png'))); ?>"
                                    class="img-fluid user-img-one" alt="<?php echo e($bundle->user->fname); ?>">
                            </a>
                        </div>
                        <div class="view-dtl">
                            <div class="view-heading"><a
                                    href="<?php echo e(route('bundle.detail', $bundle->slug)); ?>"><?php echo e(str_limit($bundle->title, $limit = 30, $end = '...')); ?></a>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="user-name">
        ...
        <div id="bundle-view-slider" class="student-view-slider-main-block owl-carousel">
            ...
            <div class="item student-view-block student-view-block-1">
                <div class="genre-slide-image <?php if($gsetting['course_hover'] == 1): ?> protip <?php endif; ?>"
                    ...
                    <div class="view-block">
                        <div class="view-img">
                            <a href="<?php echo e(route('bundle.detail', $bundle->slug)); ?>">
                        ...
                        <div class="view-user-img">
                            <a href="<?php echo e(route('all/profile', $bundle->user->id)); ?>" title="<?php echo e($bundle->user->fname); ?>">
                                <img src="<?php echo e(asset($bundle->user->user_img ? 'images/user_img/' . $bundle->user->user_img : 'images/default/user.png')); ?>" class="img-fluid user-img-one" alt="<?php echo e($bundle->user->fname); ?>">
                            </a>
                        </div>
                        <div class="view-dtl">
                            <div class="view-heading"><a
    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="view-button">
                    <a href="<?php echo e(url('bestselling-courses')); ?>" class="btn btn-secondary" title="View More">View More<i data-feather="chevrons-right"></i>
                    </a>
                </div>
            </div>
        </div>
        <div id="bestseller-view-slider" class="student-view-slider-main-block owl-carousel">
            ...
            <div class="item student-view-block student-view-block-1">
                <div class="genre-slide-image <?php if($gsetting['course_hover'] == 1): ?> protip <?php endif; ?>"
                    ...
                    <div class="view-block">
                        <div class="view-img">
                            <a href="<?php echo e(route('user.course.show', ['slug' => $best->courses->slug])); ?>" title="<?php echo e($best->courses->title); ?>">
                    ...
                    <?php if(isset($best->courses->user->id)): ?>
                        <div class="view-user-img">
                            <a href="<?php echo e(route('all/profile', $best->courses->user->id)); ?>" title="<?php echo e($best->courses->user->fname); ?>">
                                <img src="<?php echo e(asset($best->courses->user->user_img ? 'images/user_img/' . $best->courses->user->user_img : 'images/default/user.png')); ?>" class="img-fluid user-img-one" alt="<?php echo e($best->courses->user->fname); ?>">
                            </a>
                        </div>                        
                        <div class="view-dtl">
                            <?php if(isset($best->courses->user->id)): ?>
                            <div class="view-heading"><a
                                    href="<?php echo e(route('user.course.show',['slug' => $best->courses->slug ])); ?>" title="<?php echo e($best->courses->title); ?>"><?php echo e(str_limit($best->courses->title, $limit = 30, $end = '...')); ?></a>
                            </div>
                            <div class="user-name">
                                    ...
                                    <div class="col-lg-12">
                                        <?php if($best->courses->type == 1): ?>
                                            <?php if(Auth::check()): ?>
                                                <?php if(Auth::user()->role == "admin" || (!empty($order) && $order->status == 1)): ?>
                                                    <div class="protip-btn">
                                                        <a href="<?php echo e(route('course.content',['slug' => $best->courses->slug ])); ?>" class="btn btn-secondary" title="course"><?php echo e(__('Go To Course')); ?></a>
                                                    </div>
                                                <?php else: ?>
                                                    <?php
                ...
                <div class="genre-slide-image <?php if($gsetting['course_hover'] == 1): ?> protip <?php endif; ?>" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-6<?php echo e($meeting->id); ?>">
                    <div class="view-block">
                        <div class="view-img">
                            ...
                            <a href="<?php echo e(route('zoom.detail', $meeting->id)); ?>" title="<?php echo e($meeting->meeting_title); ?>"><img data-src="<?php echo e(asset('images/zoom/'.$meeting['image'])); ?>" alt="course" class="img-fluid owl-lazy"></a>
                            <?php else: ?>
                            <a href="<?php echo e(route('zoom.detail', $meeting->id)); ?>" title="<?php echo e($meeting->meeting_title); ?>"><img data-src="<?php echo e(Avatar::create($meeting['meeting_title'])->toBase64()); ?>" alt="course" class="img-fluid owl-lazy"></a>
                            <?php endif; ?>
                        ...
                        <div class="view-user-img">
                            ...
                            <a href="<?php echo e(route('all/profile',$meeting->user->id)); ?>" title="<?php echo e($meeting->meeting_title); ?>"><img src="<?php echo e(asset('images/user_img/'.$meeting->user['user_img'])); ?>" class="img-fluid user-img-one" alt="<?php echo e($meeting->meeting_title); ?>"></a>
                            <?php else: ?>
                            <a href="<?php echo e(route('all/profile',$meeting->user->id)); ?>" title="<?php echo e($meeting->meeting_title); ?>"><img src="<?php echo e(asset('images/default/user.png')); ?>" class="img-fluid user-img-one" alt="<?php echo e($meeting->meeting_title); ?>"></a>
                            <?php endif; ?>


                        </div>
                        <?php if(asset('images/meeting_icons/zoom.png') == !NULL): ?>
                        <div class="meeting-icon"><img src="<?php echo e(asset('images/meeting_icons/zoom.png')); ?>" class="img-circle" alt="<?php echo e($meeting->meeting_title); ?>"></div>
                        <?php endif; ?>


                        <div class="view-dtl">
                            <div class="view-heading"><a href="<?php echo e(route('zoom.detail', $meeting->id)); ?>" title="<?php echo e($meeting->meeting_title); ?>">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class="view-date">
                                            <i data-feather="calendar"></i>
                                                <?php echo e(date('d-m-Y',strtotime($meeting['start_time']))); ?>
                    ...
                    <div class="prime-description-under-block">
                        <div class="prime-description-under-block">
                            ...
                            ?>
                                ...
                                <?php if($meeting->paid_meeting_price && !$isPaid): ?>
                                    <p class="meeting-owner btm-10">
                                        <?php echo e(currency($meeting->paid_meeting_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true)); ?>

                                    </p>
                                    <form action="<?php echo e(route('checkoutmeeting')); ?>" method="GET">
                ...
                <div class="genre-slide-image <?php if($gsetting['course_hover'] == 1): ?> protip <?php endif; ?>" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-7<?php echo e($bbl->id); ?>">
                    <div class="view-block">
                        ...
                        <div class="view-user-img">
                            ...
                            <a href="<?php echo e(route('all/profile',$bbl->user->id)); ?>" title="<?php echo e(__('Course')); ?>"><img src="<?php echo e(asset('images/user_img/'.$bbl->user['user_img'])); ?>" class="img-fluid user-img-one" alt="<?php echo e(__('Course')); ?>"></a>
                            <?php else: ?>
                            <a href="<?php echo e(route('all/profile',$bbl->user->id)); ?>" title="<?php echo e(__('Course')); ?>"><img src="<?php echo e(asset('images/default/user.png')); ?>" class="img-fluid user-img-one" alt="<?php echo e(__('Course')); ?>"></a>
                            <?php endif; ?>


                        </div>
                        <?php if(asset('images/meeting_icons/bigblue.png') == !NULL): ?>
                        <div class="meeting-icon"><img src="<?php echo e(asset('images/meeting_icons/bigblue.png')); ?>" class="img-circle" alt="<?php echo e(__('bigblue')); ?>"></div>
                        <?php endif; ?>
                            ...
                            <div class="view-footer">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class="view-date">
                                            <i data-feather="calendar"></i>
                                                <?php echo e(date('d-m-Y',strtotime($bbl['start_time']))); ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class="view-time">
                                            <i data-feather="clock"></i>
                                                <?php echo e(date('h:i:s A',strtotime($bbl['start_time']))); ?>
                    ...
                    <div class="prime-description-under-block">
                        <div class="prime-description-under-block">
                            ...
                            <div class="des-btn-bloc">
                                ...
                                <?php if($bbl->paid_meeting_price && !$isPaid): ?>
                                <p class="meeting-owner btm-10"><?php echo e(currency($bbl->paid_meeting_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true)); ?>

                                </p>
                                <form action="<?php echo e(route('checkoutmeeting')); ?>" method="GET">
                                    <input type="hidden" name="meeting_id" value="<?php echo e($bbl->id); ?>">
            ...
            <div class="item student-view-block student-view-block-1">
                <div class="genre-slide-image <?php if($gsetting['course_hover'] == 1): ?> protip <?php endif; ?>" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-6<?php echo e($meeting['meeting_id']); ?>">
                    <div class="view-block">
                        ...
                        <div class="meeting-icon"><img src="<?php echo e(asset('images/meeting_icons/google.png')); ?>" class="img-circle" alt="<?php echo e(__('google image')); ?>"></div>
                        <?php endif; ?>

                        <div class="view-dtl">
                            <div class="view-heading"><a href="<?php echo e(route('googlemeetdetailpage.detail', $meeting['id'])); ?>">
                                    <?php echo e(str_limit($meeting->meeting_title, $limit = 30, $end = '...')); ?></a></div>
                            <div class="user-name">
                                <h6>By <span><a href="<?php echo e(route('all/profile',$meeting->user->id)); ?>"> <?php echo e(optional($meeting->user)['fname']); ?></a></span></h6>
                            </div>
                ...
                <div id="prime-next-item-description-block-6<?php echo e($meeting['meeting_id']); ?>" class="prime-description-block">
                    <div class="prime-description-under-block">
                        <div class="prime-description-under-block">
                            <h5 class="description-heading"><a href="<?php echo e(route('googlemeetdetailpage.detail', $meeting->id)); ?>"><?php echo e($meeting['meeting_title']); ?></a>
                            </h5>
                            <div class="protip-img">
                                <h6 class="user-name"><?php echo e(__('by')); ?>
                            ...
                            <div class="des-btn-block">
                                ...
                                <?php if($meeting->paid_meeting_price && !$isPaid): ?>
                                <p class="meeting-owner btm-10"><?php echo e(currency($meeting->paid_meeting_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = true)); ?>
                                ...
                                <?php else: ?>
                                <a href="<?php echo e($meeting->meet_url); ?>" target="_blank" class="btn btn-light">
                                    <?php echo e(__(' Join Meeting')); ?></a>
                                <?php endif; ?>
            ...
            <div class="item student-view-block student-view-block-1">
                <div class="genre-slide-image <?php if($gsetting['course_hover'] == 1): ?> protip <?php endif; ?>" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-6<?php echo e($meeting['meeting_id']); ?>">
                    <div class="view-block">
                        ...
                        <div class="meeting-icon"><img src="<?php echo e(asset('images/meeting_icons/jitsi.png')); ?>" class="img-circle" alt="<?php echo e(__('jitsi')); ?>"></div>
                        <?php endif; ?>

                        <div class="view-dtl">
                            <div class="view-heading"><a href="<?php echo e(route('jitsipage.detail', $meeting['id'])); ?>">
                                    <?php echo e(str_limit($meeting->meeting_title, $limit = 30, $end = '...')); ?></a></div>
                            <div class="user-name">
                                <h6>By <span><a href="<?php echo e(route('all/profile',$meeting->user->id)); ?>"> <?php echo e(optional($meeting->user)['fname']); ?></a></span></h6>
                            </div>
            ...
            <div class="item">
                <div class="instructor-home-block text-center">
                    <div class="instructor-home-block-one">
                        ...
                        <a href="<?php echo e(route('allinstructor/profile',$inst->id)); ?>" title="<?php echo e($fullName); ?>">
                            <img src="<?php echo e($userImg ? url('/images/user_img/'.$userImg) : Avatar::create($inst->user->fname)->toBase64()); ?>" class="img-fluid" alt="<?php echo e($inst->user->fname); ?>" />
                        </a>
                        ...
                        <div class="instructor-home-dtl">
                            <h4 class="instructor-home-heading"><a href="#" title="<?php echo e($fullName); ?>"><?php echo e($fullName); ?></a></h4>
                ...
                <div class="genre-slide-image <?php if($gsetting['course_hover'] == 1): ?> protip <?php endif; ?>"
                    ...
                    <div class="view-img">
                        ...
                        $imageSrc = $image ? asset('images/blog/'.$image) : Avatar::create($blog->heading)->toBase64();
                            ...
                            ?>
                            <a href="<?php echo e($detailRoute); ?>" title="<?php echo e($heading); ?>">
                        ...
                        <div class="view-user-img">
                            ...
                            <a href="<?php echo e(route('all/profile', $userId)); ?>" title="<?php echo e($heading); ?>">
                                <img src="<?php echo e($imgSrc); ?>" class="img-fluid user-img-one" alt="<?php echo e($heading); ?>">
                            </a>
                        </div>
                            <div class="tooltip">
                                <div class="tooltip-icon">
                        ...
                        <div class="view-dtl">
                            ...
                            <a href="<?php echo e($route); ?>" title="<?php echo e($heading); ?>"><?php echo e($heading); ?></a>
                        </div>
                            <div class="user-name">
                                <h6>By <span><a href="<?php echo e(route('all/profile', optional($blog->user)->id)); ?>" title="<?php echo e($heading); ?>"><?php echo e(optional($blog->user)->fname); ?></a></span></h6>
                            </div>
                           <div class="view-footer">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <div class="recommendations-main-slider">
                            <div class="recommendations-img">
                                <img src="<?php echo e($gets['img'] ? url('/images/joininstructor/'.$gets->img) : Avatar::create($gets->text)->toBase64()); ?>" alt="<?php echo e($gets->text); ?>">
                            </div>
    ...
    <section id="categories" class="categories-main-block">
        <div class="container-xl">
            <?php if($category->where('featured', '1')->count() > 0): ?>
                <h3 class="student-heading"><?php echo e(__('Featured Categories')); ?></h3>
                <div class="row">
                        ...
                        <?php if($t->status == 1 && $t->featured == 1): ?>
                            <div class="col-lg-2 col-md-4 col-sm-4 col-6">
                                <div class="cat-container btm-20 text-center">
                                    <a href="<?php echo e(route('category.page',['slug' => $cat->slug])); ?>">
                                        <div class="cat-img">
                                            <img src="<?php echo e($t['cat_image'] ? asset('images/category/'.$t['cat_image']) : Avatar::create($t->title)->toBase64()); ?>" alt="<?php echo e($t->title); ?>">
                                        </div>
                                        <div class="cat-dtl">
                                            <div>
                                                <span>
...
<?php if($hsetting->testimonial_enable == 1 && !$testi->isEmpty()): ?>
    <section id="testimonial" class="testimonial-main-block">
        <div class="container-xl">
            <h4 class="student-heading"><?php echo e(__('Testimonial')); ?></h4>
                ...
                <?php $__currentLoopData = $testi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="item testi-block text-center">
                        <div class="testi-block-images">
                            <img src="<?php echo e(url('images/testimonial/testimonial.png')); ?>" class="img-fluid" alt="<?php echo e(__('testimonial')); ?>"> 
                        </div>
...
<?php if($hsetting->service_enable == 1 && !$services->isEmpty() && isset($servicesetting)): ?>
    <section id="services" class="services-main-block">
        <div class="container-xl">
            <h4 class="student-heading"><?php echo e(__('Our Service')); ?></h4>
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="service-side-img">
                        <img src="<?php echo e($servicesetting['image'] ? asset('images/services/'.$servicesetting['image']) : Avatar::create($servicesetting->title)->toBase64()); ?>" class="img-fluid" alt="<?php echo e($servicesetting->title); ?>">
                        <div class="overlay-bg"></div>
                    </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="service-block">
                                    <div class="service-img text-center">
                                        <img src="<?php echo e($ser['image'] ? asset('images/service/'.$ser['image']) : Avatar::create($ser->title)->toBase64()); ?>" class="img-fluid" alt="<?php echo e($ser->title); ?>">
                                    </div>
                                    <div class="service-dtl text-center">
                                        <h5 class="service-heading"><?php echo e($ser->title); ?></h5>
...
<?php if($hsetting->video_enable == 1 && isset($videosetting)): ?>
    <section id="video" class="video-main-block">
        <div class="video-block parallax" style="background-image: url('<?php echo e($videosetting->image ? asset('images/videosetting/' . $videosetting->image) : Avatar::create($videosetting->tittle)->toBase64()); ?>');">
            <div class="overlay-bg"></div>
        </div>
        ...
        <div id="instructor-home-slider" class="instructor-home-main-slider owl-carousel">
            <?php $__currentLoopData = $instructors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
             <div class="item">
                <div class="instructor-home-block text-center">
                    <div class="instructor-home-block-one">
                        <a href="<?php echo e(route('allinstructor/profile',$inst->id)); ?>" title="<?php echo e($inst->fname); ?>">
                            <?php if($inst['user_img'] !== NULL && $inst['user_img'] !== ''): ?>
                                <img src="<?php echo e(url('/images/user_img/'.$inst['user_img'])); ?>" alt="course" class="img-fluid">
                            <?php else: ?>
                        ...
                        <div class="instructor-home-dtl">
                            <h4 class="instructor-home-heading">
                                <a href="<?php echo e(route('allinstructor/profile',$inst->id)); ?>" title="<?php echo e($inst->fname); ?>"><?php echo e($inst->fname); ?> <?php echo e($inst->lname); ?></a>
                            </h4>
                            <p><?php echo e($inst->role); ?></p>
                            <?php
                                $followers = App\Followers::where('user_id', '!=', $inst->id)->where('follower_id', $inst->id)->count();
...
<section id="get-started" class="get-started-main-block">
    <div class="get-started-block">
        ...
        <div class="get-started-dtl text-center">
            <h1 class="get-started-title text-white text-center"><?php echo e($get_enable->heading); ?></h1>
    ...
    <div class="container-xl">
        ...
        <div id="institute-home-slider" class="instructor-home-main-slider owl-carousel">
            ...
            <div class="item">
                <div class="instructor-home-block text-center">
                    <div class="instructor-home-block-one">
                        <a href="<?php echo e(route('ins.sluging', ['slug' => $inst->slug])); ?>" title="<?php echo e($inst->fname); ?>">
                        ...
                        <div class="instructor-home-dtl">
                            <h4 class="instructor-home-heading"><a href="<?php echo e(route('ins.sluging', ['slug' => $inst->slug])); ?>" title="<?php echo e($inst->fname); ?>"><?php echo e($inst->title); ?></a></h4>
        ...
        <div class="row">
            <div class="col-lg-7 col-md-7">
                <div class="feature-block">
                    <h4 class="student-heading"><?php echo e($featuresetting->title); ?></h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="feature-dtl-icon">
                                <img src="<?php echo e($data['image'] ? asset('images/feature/'.$data['image']) : Avatar::create($data->title)->toBase64()); ?>" class="img-fluid" alt="<?php echo e($data->title); ?>">
                            </div>
            ...
            <div class="col-lg-5 col-md-5">
                <div class="feature-image">
                    <img src="<?php echo e($featuresetting['image'] ? asset('images/feature/'.$featuresetting['image']) : Avatar::create($featuresetting->title)->toBase64()); ?>" class="img-fluid" alt="<?php echo e($featuresetting->title); ?>">
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\downloaded apps\xampp\htdocs\edutask\resources\views/home.blade.php ENDPATH**/ ?>