                ...
                <div class="col-lg-6 col-md-6">
                    <div class="infobar">
                        ...
                        <ul class="list-inline mb-0">
                            ...
                            <?php if($gsetting->api_enable == '1'): ?>
                            <li class="list-inline-item">   
                                <div class="ai-tool-block">
                                    <a href="#" class="menu-tigger infobar-icon"><img src="<?php echo e(url('admin_assets/assets/images/svg-icon/ai.svg')); ?>" class="img-fluid" alt="<?php echo e(__('Ai Tool')); ?>"><span><?php echo e(__('Ai Tool')); ?></span></a>
                                </div>
                            </li>
                            <?php endif; ?>
                            <!-- = site visit end -->
...
<!-- End Breadcrumbbar --><?php /**PATH /home/keramfvp/edutech.keralify.com/resources/views/admin/layouts/topbar.blade.php ENDPATH**/ ?>