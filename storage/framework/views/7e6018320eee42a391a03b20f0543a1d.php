    ...
    <div class="container-xl">
        ...
        <div class="navigation fullscreen-search-block">
            <div class="container">
                ...
                <div class="mobile-bottom-bar" id="mobileTabs" style="    position: fixed;
    bottom: 0;
    left: 0;
    background: white;
    width: 100%;">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading active" role="tab" id="headingOne">
                                ...
                                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne<?php echo e($cate->id); ?>" aria-expanded="true" aria-controls="collapseOne">
                                    <i class="fa <?php echo e($cate->icon); ?> rgt-10"></i> <label class="prime-cat" data-url="<?php echo e(route('category.page',['slug' => $cate->slug])); ?>"><?php echo e(str_limit($cate->title, $limit = 20, $end = '..')); ?></label>  <i class="fas fa-chevron-down"></i>
                                </a>
                                </h4>
                            </div>                        
                                        ...
                                        <div class="panel-body">
                                            <div class="panel panel-default">
                                                ...
                                                <h4 class="panel-title">
                                                    ...
                                                    <i class="fa <?php echo e($sub->icon); ?> rgt-10"></i> <label class="sub-cate" data-url=<?php echo e(route('subcategory.page', ['categorySlug' => $sub->categories->slug, 'slug' => $sub->slug])); ?>"><?php echo e(str_limit($sub->title, $limit = 15, $end = '..')); ?></label>
                                                ...
                                                <div class="panel-body sub-cat">
                                                    <i class="fa <?php echo e($child->icon); ?> rgt-10"></i> <label class="child-cate" data-url="<?php echo e(route('childcategory.page',['categorySlug' => $child->categories->slug, 'subCategorySlug' => $child->subcategory->slug ,'slug' =>  $child->slug ])); ?>"><?php echo e($child->title); ?> </label>
                                                </div>
                                                <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>                                
                                ...
                                <ul>
                                    <li class="mr-4"><a href="#" title="<?php echo e(__('Categories')); ?>"><i data-feather="grid"></i><?php echo e(__('Categories')); ?></a>                                       
                                        <ul>
                                            ...
                                            <li><a href="<?php echo e(route('category.page',['slug' => $cate->slug])); ?>" title="<?php echo e($cate->title); ?>"><i class="fa <?php echo e($cate->icon); ?> rgt-20"></i><?php echo e(str_limit($cate->title, $limit = 25, $end = '..')); ?> <i data-feather="chevron-right" class="float-right"></i></a>
                                            <ul>   
                                                <?php $__currentLoopData = $cate->subcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($sub->status ==1): ?>
                                                <li><a href="<?php echo e(route('subcategory.page', ['categorySlug' => $sub->categories->slug, 'slug' => $sub->slug])); ?>" title="<?php echo e($sub->title); ?>"><i class="fa <?php echo e($sub->icon); ?> rgt-20"></i><?php echo e(str_limit($sub->title, $limit = 25, $end = '..')); ?>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <?php if($child->status ==1): ?>
                                                        <li>
                                                            <a href="<?php echo e(route('childcategory.page',['categorySlug' => $child->categories->slug, 'subCategorySlug' => $child->subcategory->slug ,'slug' =>  $child->slug ])); ?>" title="<?php echo e($child->title); ?>"><i class="fa <?php echo e($child->icon); ?> rgt-20"></i><?php echo e(str_limit($child->title, $limit = 25, $end = '..')); ?></a>
                                                        </li>
                                                        <?php endif; ?>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="Login-btn">
                            ...
                            <a href="<?php echo e(url('registers')); ?>" class="btn btn-secondary" title="<?php echo e(__('Signup')); ?>"><?php echo e(__('Signup')); ?></a>                            
                        </div> 
                    </div>
                <?php endif; ?>
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <div class="col-lg-1 col-md-1 col-sm-2 col-2">
                        <div class="search search-one" id="search">
                            ...
                            <?php
                                ...
                                $pages = App\Page::get();
                            ?>
                                <?php if(isset($menus) && $menus->isNotEmpty() && $pages->isNotEmpty()): ?>
                                <div class="col-lg-1">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(url('/account/delete')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('instructormodel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\downloaded apps\xampp\htdocs\edutask\resources\views/theme/nav.blade.php ENDPATH**/ ?>