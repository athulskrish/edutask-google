        ...
        <div class="card">
          ...
          <div class="card-body" id="stepbox">
               <form action="{{url('verifycode')}}" id="stepvform" method="POST" class="needs-validation" novalidate>                  
                  {{ csrf_field() }}
                   <h3>{{ __('Envato Purchase details') }}</h3> Licensed By DoniaWeB
                   <hr>
                  <div class="form-row">
                    ...
                    <div class="eyeCy col-md-6 mb-3">
                      ...
                      <input name="code" type="password" class="form-control" id="validationCustom02" placeholder="Please enter valid purchase code" value="DoniaWeB" autocomplete="off" required>
